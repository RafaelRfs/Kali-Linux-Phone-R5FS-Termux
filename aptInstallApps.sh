...
apt -y upgrade
apt install -y  net-tools fail2ban aide php sudo php-curl python python-pip python3-pip postgresql postgresql-contrib ftp-ssl iptables ettercap-text-only sslstrip dsniff bluetooth
pip install scapy
